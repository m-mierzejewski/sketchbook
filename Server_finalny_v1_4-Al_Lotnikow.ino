...
const int PRZ3 = 18; // Przelącz prąd L3
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /CW/on") >= 0) {
              ...
              Serial.println("Przestawiam przekazni 1k");
              digitalWrite(PRZ1,HIGH);
              delay(200);
              digitalWrite(PRZ1,LOW);
            ...
            client.println("<h2>Prad P. 1 " + PRSt1 + "</h2>");          
            if (PRSt1=="wylaczony") {
            ...
            client.println("<h2>Prad P. 2 " + PRSt2 + "</h2>");               
            if (PRSt2=="wylaczony") {
            ...
            client.println("<h2>Prad P. 3 " + PRSt3 + "</h2>");               
            if (PRSt3=="wylaczony") {
