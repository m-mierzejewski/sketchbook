...
const int PRZ6 = 21; // Przelącz gniazda kuchnia (11)
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<h2>Prad gn. kuchnia - " + PRSt6 + "</h2>");               
            if (PRSt6=="wylaczony") {
            ...
            client.println("<h2>Prad gn. RTV - przelacz </h2>"); 
            ...
            client.println("<h2>Prad gn. pralka - przelacz </h2>"); 
            client.println("<p><a href=\"/PR5/zmie\"><button class=\"button button4\">Przelacz</button></a></p>");
          
            client.println("<h2>Prad gn. kuchnia - przelacz </h2>"); 
